...
# 
# ## check for packages
# packages <- c("markdown", "shiny", "shinydashboard", "stringr", "dplyr", "tidyr", "DT", "readr", "plotly", "rsconnect")
...
This is first in planned series of blogs usually related to apps I develop for the [mytinyshinys site](https://mytinyshinys.shinyapps.io/dashboard/) focusing on amalysing meta data. 
...
This provides a table with apps listed with data on whether they are running and when created
...
A simple graph is produced. I tend to use plotly by default
